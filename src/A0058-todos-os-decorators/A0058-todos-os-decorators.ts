...
// Parâmetro de método
function decoradorDeParametroDeMetodo(prototipoDaClasse: any, nomeDoMetodo: string, indiceDaPropriedade: number): any {
...
function decoradorDePropriedadeEstatica(prototipoDaClasse: any, nomePropriedade: string): any {
    // Chamado na criação da propriedade
